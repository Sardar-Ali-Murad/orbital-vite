...
const Sidebar = () => {
  return (
    <div className="p-[20px] bg-[#083155] w-[100%]  overflow-y-auto h-[100%] md:w-[240px]">
      ...
      <div className="mt-[30px]">
        ...
        <div className="mt-[12px] flex flex-col gap-[14px]">
          <div className="w-[200px] h-[39.72px] top-[116px] left-[20px]  rounded-[5px] bg-[#FFAA00] flex px-[21px] py-[12px] items-center  gap-[15px]">
            <img src={chat} />
